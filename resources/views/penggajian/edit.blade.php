...
@section('content')
<h1 class="fw semi-bold text-center py-3" style="color:white">DATA PENGGAJIAN</h1>
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    <form action="{{ route('accounting.penggajian.update', $penggajian->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                        name="tanggal" id="tanggal" value="{{ old('tanggal', $penggajian->tanggal) }}" readonly>
                                    @error('tanggal')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="keterangan" id="keterangan" cols="30" rows="5"
                                        class="form-control @error('keterangan') is-invalid @enderror">{{ $penggajian->keterangan }}</textarea>
                                    @error('keterangan')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <select name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror">
                                            ...
                                            @forelse ($karyawan as $value)
                                                <option value="{{ $value->id }}" {{ $value->id == $penggajian->karyawan_id ? 'selected' : '' }}>
                                                    {{ $value->nama }}
                                                </option>
                                            @empty
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control  @error('jumlah_gaji') is-invalid @enderror"
                                        ...
                                        value="{{ old('jumlah_gaji', $penggajian->jumlah_gaji) }}" readonly>
                                    @error('jumlah_gaji')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text"
                                        ...
                                        value="{{ old('jumlah_lembur', $penggajian->jumlah_lembur) }}" readonly>
                                    @error('jumlah_lembur')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control  @error('potongan') is-invalid @enderror"
                                        ...
                                        value="{{ old('potongan', $penggajian->jumlah_cuti) }}" readonly>
                                    @error('potongan')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control @error('total_gaji') is-invalid @enderror"
                                        ...
                                        value="{{ old('total_gaji', $penggajian->total_gaji) }}" readonly>
                                    @error('total_gaji')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
